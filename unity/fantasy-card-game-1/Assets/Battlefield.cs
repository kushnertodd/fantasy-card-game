...
namespace fantasy_card_game_lib
{
    public class Battlefield
    {
        ...
        public Dictionary<Mana.ManaTypeColor, int> manaCounts = new Dictionary<Mana.ManaTypeColor, int>();
        public Deck deck;
        public Exile exile;
        ...
        public Battlefield(Deck deck)
        {
            ...
            foreach (Mana.ManaTypeColor color in Enum.GetValues(typeof(Mana.ManaTypeColor)))
            {
        ...
        public int GetManaCount(Mana.ManaTypeColor color)
        {
        ...
        public void Play(Card card, Errors errors)
        {
            ...
            else if (card.GetType() == typeof(Creature))
            {
                ...
                Mana.ManaTypeColor creatureCostColor = creature.CostColor;
